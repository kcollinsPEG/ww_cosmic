...
(function(global, $) {
    ...
    $.fn.filterizr.prototype = {
        ...
        _getFiltrItems: function() {
            var self       = this,
                filtrItems = $(self.find('.filter-item')),
                itemsArray = [];
        ...
        _calcItemPositions: function() {
            var self  = this,
                ...
                //Container data
                containerHeight = 0,
                cols = Math.round(self.width() / self.find('.blog__articles-item').outerWidth()),
                rows = 0,
                //Item data
...
$(window).on('load', function() {
    ...
    if($('.blog__articles-list').length) {
        $('.blog__articles-list').filterizr({
            delay: 50,
            delayMode: 'progressive',
    ...
    if($('.mary-tv__list').length) {
        $('.mary-tv__list').filterizr({
            delay: 50,
            delayMode: 'progressive',
            animationDuration: 0.5,
            layout: 'packed'
...
(function($) {
    $('.blog__filter a, .mary-tv__buttons a').on('click', function () {
        $('.blog__filter a, .mary-tv__buttons a').removeClass('button--red').addClass('button--gray');
        $(this).addClass('button--red').removeClass('button--gray');
    });
